...
impl StateManager {
    fn new() -> StateManager {
        ...
        living_beings.push(LivingBeing {
            id: 1,
...
impl LivingBeing {
    ...
    fn move_it(&mut self, x_diff: i32, y_diff: i32) {
        ...
        self.position = Some(Position {
            x: (old_position.x as i32 + x_diff) as u32,
            y: (old_position.y as i32 + y_diff) as u32,
        });
    }
}
...
impl GameMaster for GameServer {
    ...
    async fn game_state_streaming(
        &self,
        _: Request<GameStateRequest>,
    ) -> Result<Response<Self::GameStateStreamingStream>, Status> {
        ...
        tokio::spawn(async move {
            ...
            for i in start..20 {
                ...
                let to_send = GameStateResponse {
                    counter: i,
                    living_beings: state.living_beings.clone(),
                };
